...
# --- CONFIGURATION ---
MODEL_DIR = "distilbert-doc-classifier" # The folder where your trained model is saved
...
st.markdown("Powered by DistilBERT. Upload a PDF document (resume, invoice, or scientific paper) to see it in action.")
